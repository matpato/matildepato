...
const BriefBio = () => {
  return (
    ...
    Matilde Pato is an Adjunct Professor in Computer Science at the <a href="https://www.isel.pt/departamento/engenharia-informatica" target="_blank" rel="noopener noreferrer" className="font-bold">
    ...
    Lisbon School of Engineering</a> at <a href="https://www.ipl.pt/en" target="_blank" rel="noopener noreferrer" className="font-bold">Polytechnic University of Lisbon | Ureka</a>, 
